...
Once the `webcimes-cookies` script is added to your project, the modal will be created and displayed automatically. You can also use the `CreateWebcimesCookies` function to create a modal with your own custom options.
...
```javascript
import { CreateWebcimesCookies } from "webcimes-cookies";
```
...
<html>
  <head>
    ...
    <script type="module">
      ...
      import { CreateWebcimesCookies } from "./node_modules/webcimes-cookies/dist/js/webcimes-cookies.esm.js";
      ...
    </script>
  </head>
  ...
...
<html>
  <head>
    ...
    <script
      src="./node_modules/webcimes-cookies/dist/js/webcimes-cookies.udm.js"
...
<link
  rel="stylesheet"
  href="./node_modules/webcimes-cookies/dist/css/webcimes-cookies.css"
/>
```

## Usage

### Call `CreateWebcimesCookies` for create cookies modal:

```javascript
// Wait for dom content loaded or call CreateWebcimesCookies before the end of body
